...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                    this is CLCollectionViewFlowLayout
                   DESC

  s.homepage     = "https://github.com/jsonsnow/CLCollectionViewFlowLayout"
  ...
  # Or just: s.author    = "jsonsnow"
  # s.authors            = { "jsonsnow" => "1183010734@qq.com" }
  ...
  s.source       = { :git => "https://github.com/jsonsnow/CLCollectionViewFlowLayout.git", :tag => s.version.to_s }
